                                                                                                ...
                                                                                                pkgs.writeShellApplication
                                                                                                    {
                                                                                                        ...
                                                                                                        text =
                                                                                                            ''
                                                                                                                ...
                                                                                                                git -C /var/lib/workspaces/${ epoch }/repository/private add personal.hash
                                                                                                                ...
                                                                                                                then
                                                                                                                    ...
                                                                                                                    then
                                                                                                                        ...
                                                                                                                        then
                                                                                                                            ...
                                                                                                                            do
                                                                                                                                read -rp "Was the local run 1 satisfactory? y/n " SATISFACTORY
                                                                                                                            done
                                                                                                                            if [[ "$SATISFACTORY" == "y" ]]
                                                                                                                            then
                                                                                                                                ...
                                                                                                                                then
                                                                                                                                    ...
                                                                                                                                    while [[ "$SATISFACTORY" != "y" ]] && [[ "$SATISFACTORY" != "n" ]]
                                                                                                                                    do
                                                                                                                                        read -rp "Was the local run 2 satisfactory? y/n " SATISFACTORY
                                                                                                                                    done
                                                                                                                                    if [[ "$SATISFACTORY" == "y" ]]
                                                                                                                                    then
                                                                                                                                        echo "Since the runs using local sources were both satisfactory we are going to pull request changes to personal and secrets back into main."
                                                                                                                                                ...
                                                                                                                                                then
                                                                                                                                                    ...
                                                                                                                                                    then
                                                                                                                                                        ...
                                                                                                                                                        then
                                                                                                                                                            ...
                                                                                                                                                            git -C /var/lib/workspaces/${ epoch }/repository/private commit -am "DEVELOPMENT SUCCESS AT $CURRENT_TIME:  $SUCCESS_MESSAGE" --allow-empty
                                                                                                                                                            ...
                                                                                                                                                            git -C /var/lib/workspaces/${ epoch }/repository/private commit -am "$SUCCESS_MESSAGE" --allow-empty
                                                                                                                                                            ...
                                                                                                                                                            then
                                                                                                                                                                ...
                                                                                                                                                                then
                                                                                                                                                                    ...
                                                                                                                                                                    git -C /var/lib/workspaces/${ epoch }/repository/private add personal.hash secrets.hash
                                                                                                                                                                    git -C /var/lib/workspaces/${ epoch }/repository/private commit -am "MAIN SUCCESS AT $CURRENT_TIME:  $SUCCESS_MESSAGE" --allow-empty
                                                                                                                                    ...
                                                                                                                                    then
                                                                                                                                        read -rp "Details:  " DETAILS
                                                                                                                                        MESSAGE="The private repository ran unsatisfactory 2 from local sources at $CURRENT_TIME:  $DETAILS"
                                                                                                                                        git -C /var/lib/workspaces/${ epoch }/repository/private commit -am "$MESSAGE"
                                                                                                                                        echo "$MESSAGE" >&2
                                                                                                                                        exit 64
                                                                                                                                    fi
                                                                                                                            ...
                                                                                                                            then
                                                                                                                                read -rp "Details:  " DETAILS
                                                                                                                                MESSAGE="The private repository ran unsatisfactory 1 from local sources at $CURRENT_TIME:  $DETAILS"
                                                                                                                                git -C /var/lib/workspaces/${ epoch }/repository/private commit -am "$MESSAGE"
                                                                                                                                echo "$MESSAGE" >&2
                                                                                                                                exit 64
                                                                                                                            fi

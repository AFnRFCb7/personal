                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-promote } stage/alias/root/mutable-promote 0500 --literal-plain BIN_1 --literal-plain BIN_2 --literal-plain PARENT_1 --literal-plain PARENT_2 --literal-plain PATH --literal-plain STUDIO_1 --literal-plain STUDIO_2
                                                                                                                            wrap ${ mutable-rebase } stage/alias/root/mutable-rebase 0500 --literal-plain BRANCH --set-plain INDEX "$INDEX" --literal-plain NAME --literal-plain PATH --literal-plain UUID --literal-plain TOKEN --literal-plain TOKEN_DIRECTORY
                                                                                                                            wrap ${ mutable-snapshot.root } stage/alias/root/mutable-snapshot 0500 --literal-plain BRANCH --literal-plain COMMIT --set-plain MOUNT "${ mount }" --literal-plain MUTABLE_SNAPSHOT
                                                                                                                            wrap ${ mutable-snapshot.submodule } stage/alias/submodule/mutable-snapshot 0500 --literal-plain BRANCH --literal-plain NAME --literal-plain TOKEN --literal-plain TOKEN_DIRECTORY --literal-plain UUID
                                                                                                                            wrap ${ mutable-squash } stage/alias/root/mutable-squash 0500 --literal-plain BRANCH --literal-plain name --set-plain MOUNT "${ mount }" --literal-plain toplevel --literal-plain UUID
                                                                                                                            wrap ${ mutable- "switch" } stage/alias/root/mutable-switch 0500 --set-plain MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable- "test" } stage/alias/root/mutable-test 0500 --set-plain MOUNT "${ mount }"
                                                                                                                            wrap ${ ssh } stage/ssh/command 0500 --set-plain MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-snapshot.submodule } stage/alias/submodule/mutable-switch 0500 --set-plain MOUNT "${ mount }"
                                                    ...
                                                    standard-input = "5433bd8482be1f2e1c1db4fa9268ed6e7bb02285083decb86a6166eea2df77f7e2d7524541549a3ee73d03ae955d8ec0714a959944962e8fe18f343fe108ff9f" ;
                                                     standard-error =
                                                         ''
                                                                ...
                                                                run-time-arguments:
                                                                  - b06fc102
                                                                  - /nix/store/pxhqi6sk4b5m9bj4pkk3y8a4fdjn8svy-setup/bin/setup

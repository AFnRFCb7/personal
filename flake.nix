                                                                                                                                ...
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ...
                                                                                                                                            wrap ${ aliases.github-identity } "$MOUNT/stage/aliases/github-identity" 0500 --inherit-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ aliases.github-known-hosts } "$MOUNT/stage/aliases/github-known-hosts" 0500 --inherit-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ aliases.github-token } "$MOUNT/stage/aliases/github-token" 0500 --inherit-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ aliases.gnupg-ownertrust } "$MOUNT/stage/aliases/gnupg-ownertrust" 0500 --inherit-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ aliases.gnupg-secret-keys } "$MOUNT/stage/aliases/gnupg-secret-keys" 0500 --inherit-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ aliases.mobile-identity } "$MOUNT/stage/aliases/mobile-identity" 0500 --inherit-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ aliases.mobile-known-hosts } "$MOUNT/stage/aliases/mobile-known-hosts" 0500 --inherit-plain MOUNT --literal-plain PATH

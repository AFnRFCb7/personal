                                                                                                    ...
                                                                                                    pkgs.writeShellApplication
                                                                                                        {
                                                                                                            ...
                                                                                                            text =
                                                                                                                let
                                                                                                                    ...
                                                                                                                    in
                                                                                                                        ''
                                                                                                                            wrap ${ mutable-build-vm } stage/bin/mutable-build-vm 0500 --literal GIT_SSH_COMMAND --envsubst "${ pkgs.gettext }/bin/envsubst" --literal MUTABLE_SNAPSHOT --literal PATH --set MOUNT "${ mount }" --set VM "build-vm"
                                                                                                                            wrap ${ mutable-build-vm } stage/bin/mutable-build-vm-with-bootloader 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal MUTABLE_SNAPSHOT --literal PATH --set MOUNT "${ mount }" --set VM "build-vm-with-bootloader"
                                                                                                                            wrap ${ mutable-converge } stage/bin/mutable-converge 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal MUTABLE_SNAPSHOT --literal PATH --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-check } stage/bin/mutable-check 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal MUTABLE_SNAPSHOT --literal PATH --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-snapshot } stage/bin/mutable-snapshot 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal BRANCH --literal COMMIT --literal "MUTABLE_SNAPSHOT" --literal PATH --literal "UUID" --set MOUNT "${ mount }"
                                                                                                                            echo b100b366 "$0" wrap ${ mutable-snapshot } stage/bin/mutable-snapshot 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal BRANCH --literal COMMIT --literal "MUTABLE_SNAPSHOT" --literal PATH --literal "UUID" --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-switch } stage/bin/mutable-switch 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal GIT_SSH_COMMAND --literal MUTABLE_SNAPSHOT --literal PATH --literal STAMP --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-test } stage/bin/mutable-test 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal GIT_SSH_COMMAND --literal MUTABLE_SNAPSHOT --literal PATH --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-token } stage/bin/mutable-token 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal TOKEN --literal PATH --literal RECIPIENTS --set MOUNT "${ mount }"
                                                                                                                            ln --symbolic ${ root }/bin/root "${ mount }/stage/bin/root"
                                                                                                                            ln --symbolic ${ wrap }/bin/wrap "${ mount }/stage/bin/wrap"



                                                                                                                            wrap ${ mutable-nurse } stage/mutable-nurse 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal INPUT --literal COMMIT --literal REPO_NAME --literal USER_NAME --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-rebase } stage/mutable-rebase 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal FAILURE --literal STATUS --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-scratch } stage/mutable-scratch 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal BRANCH --literal UUID --set MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-snapshot-prime } stage/mutable-snapshot 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal COMMIT --literal FAILURE --literal GIT_SSH_COMMAND --literal SNAPSHOT --literal STATUS --set MOUNT "${ mount }"
                                                                                                                        '' ;
                                                                                                        } ;
                                                                                                    in "${ application }/bin/post-setup" ;
                                                                                    pre-setup =
                                                                                                            ...
                                                                                                            text =
                                                                                                                ...
                                                                                                                in
                                                                                                                    ''
                                                                                                                        ...
                                                                                                                        root "$DOT_SSH"
                                                                                                                        ln --symbolic "$DOT_SSH/config" /mount/stage/config
                                                                                                                        wrap ${ mutable-hydrate } stage/mutable-hydrate 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --literal BRANCH --literal COMMIT --set MOUNT "${ mount }"
                                                                                                                        wrap ${ ssh } stage/ssh 0500 --envsubst "${ pkgs.gettext }/bin/envsubst" --set MOUNT "${ mount }"

                                                                                                                        ...
                                                                                                                        let
                                                                                                                            ...
                                                                                                                            in
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    wrap ${ mutable-switch.root } stage/alias/root/mutable-switch 0500 --set-plain MOUNT "${ mount }" --literal-plain PATH
                                                                                                                                    wrap ${ mutable-switch.submodule } stage/alias/submodule/mutable-switch 0500 --literal--plain name --literal-plain PATH --literal-plain toplevel

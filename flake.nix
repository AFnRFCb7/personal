                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                export GNUPGHOME="$DOT_GNUPG/dot-gnupg"
                                                                                                                                                                KEY_ID="$MONIKER $NOW"
                                                                                                                                                                gpg --homedir "$GNUPGHOME" --yes --quick-gen-key "$KEY_ID" ed25519 sign 1y
                                                                                                                                                                gpg --homedir "$GNUPGHOME" --yes --quick-add-key "$KEY_ID" cv25519 encrypt 1y
                                                                                                                                                                mkdir --parents "$MOUNT/stage/private"
                                                                                                                                                                SECRETS=${ builtins.trace ( builtins.concatStringsSep " , " ( builtins.attrNames resources.productions.repository ) ) ( resources.production.repository.secrets ( setup : setup ) ) }

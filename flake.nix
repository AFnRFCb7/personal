                                                                            ...
                                                                            resources.lib
                                                                                {
                                                                                    ...
                                                                                    token-good = 5000 ;
                                                                                    token-no-init = 5000 ;
                                                                                    token-recovery-setup = 5100 ;
                                                                                    token-recovery-teardown = 5300 ;
                                                                                    token-stall-for-cleanup = 5200 ;
                                                                                    token-stall-for-process = 5100 ;
                                                                                    token-stale = 5000 ;
                                                                                    token-teardown-aborted = 5300 ;
                                                                                    token-teardown-final = 5300 ;
                                                                                    transient = transient ;
                                                                                    visitor = visitor ;
                                                                                    writeShellApplication = pkgs.writeShellApplication ;
                                                                                    yq-go = pkgs.yq-go ;
                                                                    ...
                                                                    resources.lib
                                                                        {
                                                                            ...
                                                                            token-recovery-setup = 5100 ;
                                                                            token-recovery-teardown = 5300 ;
                                                                            token-stall-for-cleanup = 7200 ;
                                                                            token-stall-for-process = 7100 ;
                                                                            token-stale = 4000 ;
                                                                            token-teardown-aborted = 7300 ;
                                                                            token-teardown-final = 7300 ;
                                                                            targets = [ "target" ] ;
                                                                            visitor = visitor ;
                                                                            yq-go = pkgs.yq-go ;
                                                                            writeShellApplication = pkgs.writeShellApplication ;

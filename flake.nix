                                                                                                                                                                ...
                                                                                                                                                                switch =
                                                                                                                                                                    {
                                                                                                                                                                        ...
                                                                                                                                                                        text =
                                                                                                                                                                            ''
                                                                                                                                                                                ...
                                                                                                                                                                                git submodule foreach '${ scripts.submodule.switch }'
                                                                                                                                                                                ...
                                                                                                                                                                                echo 71fc97ef d3cd0739 PWD="$(pwd)" core.sshCommand="$(git config --get core.sshCommand)"
                                                                                                                                                                                git fetch origin main
                                                                                                                                                                ...
                                                                                                                                                                test =
                                                                                                                                                                    {
                                                                                                                                                                        ...
                                                                                                                                                                        text =
                                                                                                                                                                            ''
                                                                                                                                                                                REPOSITORY="$( git rev-parse --show-toplevel )" || failure df79aa5d
                                                                                                                                                                                cd "$REPOSITORY"

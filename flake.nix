                                                                                                                        ...
                                                                                                                        then
                                                                                                                            ...
                                                                                                                            then
                                                                                                                                ...
                                                                                                                                then
                                                                                                                                    ...
                                                                                                                                    jq --null-input --arg TYPE "resolve-init" '{ "index" : .index , "release" : .description.seed.secondary.release , "resolutions" : description.seed.secondary.resolutions.release , "type" : $TYPE }' <<< "$PAYLOAD" | redis-cli PUBLISH > /dev/null
                                                                                                                                else

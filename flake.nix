                                                                                    ...
                                                                                    ''
                                                                                        ...
                                                                                        _myscript_completions() {
                                                                                            ...
                                                                                            then
                                                                                                if [[ $COMP_CWORD -eq 1 ]]
                                                                                                then
                                                                                                    NEXT="$( compgen -W "production.age production.application.chromium production.application.mutable production.repository.pass production.repository.secrets.read-only production.dot-gnupg production.dot-ssh archaic" -- "$cur" )" || failure 6bb37017
                                                                                                    COMPREPLY=( $NEXT )
                                                                                                fi
                                                                                            else
                                                                                                COMPREPLY=()

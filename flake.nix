                                                                                                    ...
                                                                                                    let
                                                                                                        ...
                                                                                                        in
                                                                                                            ''
                                                                                                                ...
                                                                                                                # shellcheck disable=SC2016
                                                                                                                wrap ${ pre-commit } cipher/.git/hooks/pre-commit 0500 --literal-plain CIPHERTEXT_FILE --literal-plain FILE --literal-plain IDENTITY --inherit-plain MOUNT --literal-plain PATH --literal-plain PLAINTEXT_FILE --literal-brace 'PLAINTEXT_FILE#"$MOUNT"/plain/' --literal-plain STAGED_FILE --uuid e7266fc5

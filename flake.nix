                                                                                                                                ...
                                                                                                                                pkgs.writeShellApplication
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        text =
                                                                                                                                            ''
                                                                                                                                                ...
                                                                                                                                                update
                                                                                                                                                nixos-rebuild build-vm --flake "$MOUNT/repository#user"
                                                                                                                                            '' ;
                                                                                                                                    } ;
                                                                                                                                ...
                                                                                                                                pkgs.writeShellApplication
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        text =
                                                                                                                                            ''
                                                                                                                                                : "${ builtins.concatStringsSep "" [ "$" "{" "MOUNT:? Must export MOUNT before running this script" "}" ] }"
                                                                                                                                                update
                                                                                                                                                nixos-rebuild build-vm-with-bootloader --flake "$MOUNT/repository#user"
                                                                                                                                            '' ;
                                                                                                                                    } ;
                                                                                                                            in "${ application }/bin/build-vm" ;
                                                                                                                    check =
                                                                                                                                ...
                                                                                                                                pkgs.writeShellApplication
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        text =
                                                                                                                                            ''
                                                                                                                                                ...
                                                                                                                                                BRANCH="$1"
                                                                                                                                                echo 8f98390dc79f033dd08508dbf6eaedd764877353543800b235ffdb11c478efcca42dac05318cba1e7fc6b2d6094e3ea951c810ff3297e0bd0b012c00f6e9eeae
                                                                                                                                                echo "git -c protocol.version=0 fetch origin \"$BRANCH\" 2>&1"
                                                                                                                                                echo 412164cb06b751aa5e7e30090cfd6dac215ec4b43ec5d3c58f48614719f853913137a6865f267b9225979dae20c587afdd57fef65a7673a8f8d6120123fcf4bc
                                                                                                                                                git -c protocol.version=0 fetch origin "$BRANCH" 2>&1
                                                                                                                                                echo 4153764936df75f534c98c166eae41dc11f923d62f48cabd3f2a36adc8f90d4a946dd0790bfe74f02c5ec0b2c23dc78a4f2863dcfd6387f9675ef3d5138319b3
                                                                                                                                                git checkout "origin/$BRANCH" 2>&1
                                                                                                                                                echo e054b724ed4f3b4a0e81240861f7acc2f53b730bba21ead9f604c75cc43ed3f564128a2153a32a07d170e0e6b53ee8ce40f141a1c23ed77fa52ded66b330c6c1
                                                                                                                                                git scratch
                                                                                                                                                echo 6e535bb4671e1426219c3b06a719092109f9b40eca7980ddbc807d76418578e34c25ad7e2e7e8321afb1a04b053c3e38746a0936e7304a6cae36937b72c6411a
                                                                                                                                                git submodule sync 2>&1
                                                                                                                                                echo 18c8cf9603b125478ebae0bad69da3305e3b1c23d3389f915dd24f7c0e5a354b42ab5244c892785f12c77b0c4b66e4606bf438c33cff71985c688f6065d67e4b
                                                                                                                                                git submodule update --init --recursive 2>&1
                                                                                                                                                echo 9e2ef094a649ad28c4f46f533a6f9adfe83e4c8243837af4961141e088bbc47786c9746235eeacae142f3d01ee30a7b9a6e50c549ac8c171dd7ff47a09029892
                                                                                                                                            '' ;
                                                                                                                                    } ;

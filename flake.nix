                                                                                                    ...
                                                                                                    let
                                                                                                                            ...
                                                                                                                            text =
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    do
                                                                                                                                        ...
                                                                                                                                        RECIPIENTS="$( age-keygen --export-public-key --identity ${ config.personal.agenix } )" || failure 48550b32
                                                                                                                                        age --encrypt --recipients "$RECIPIENTS" --output "$CIPHERTEXT_FILE" --armor "$PLAINTEXT_FILE"
                                                                                                        ...
                                                                                                        in
                                                                                                            ''
                                                                                                                ...
                                                                                                                # shellcheck disable=SC2016
                                                                                                                wrap ${ pre-commit } cipher/.git/hooks/pre-commit 0500 --literal-plain CIPHERTEXT_FILE --literal-plain FILE --inherit-plain MOUNT --literal-plain PATH --literal-plain PLAINTEXT_FILE --literal-brace 'PLAINTEXT_FILE#"$MOUNT"/plain/' --literal-plain STAGED_FILE --uuid e7266fc5
                                                                                                                wrap ${ pre-push } cipher/.git/hooks/pre-push 0500 --literal-plain GIT_SSH_COMMAND --literal-brace "GIT_SSH_COMMAND:?GIT_SSH_COMMAND must be exported" --literal-plain MOBILE_PUBLIC --inherit-plain MOUNT --literal-plain PATH --literal-plain RECIPIENTS --uuid c49c4509
                                                                                                            '' ;
                                                                                            } ;
                                                                                    in "${ application }/bin/init" ;

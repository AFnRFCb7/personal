                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        # ( resources-fun false false false false true false ( self + "/expected/false/false/false/true/true/false/0/checkpoint-pre" ) ( self + "/expected/false/false/false/true/true/false/0/checkpoint-post" ) [ { command = "/build/resources/recovery/0000000000000002/recovery.sh" ; checkpoint = self + "/expected/false/false/false/true/true/false/1/checkpoint" ; } ] )

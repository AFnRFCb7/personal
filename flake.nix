                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-mirror.root } stage/alias/root/mutable-mirror 0500 --literal-plain GIT_SSH_COMMAND --literal-plain NEW_BRANCH --literal-plain OLD_BRANCH --literal-plain UUID

                                                    ...
                                                    foobar =
                                                        {
                                                            ...
                                                            foobar =
                                                                ignore :
                                                                    {
                                                                        init =
                                                                            { pid , pkgs , resources , sequential , root , wrap } :
                                                                                let
                                                                                    application =
                                                                                        pkgs.writeShellApplication
                                                                                            {
                                                                                                                                ...
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ...
                                                                                                                                            wrap ${ mutable-test } stage/alias/root/mutable-test 0500 --literal-plain MOUNT --literal-plain PATH
                                                                                                                                            wrap ${ ssh } stage/ssh/command 0500 --literal-plain "@" --literal-plain MOUNT --literal-plain PATH
                                                                                                                                            DOT_SSH=${ resources.production.dot-ssh { } }
                                                                                                                                            root "$DOT_SSH"
                                                                                                                                            wrap "$DOT_SSH/config" stage/ssh/config 0400
                                                                                                                                            git remote add origin "${ config.personal.repository.private.remote }"
                                                                                                                                                    ...
                                                                                                                                                    let
                                                                                                                                                        ...
                                                                                                                                                        in
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                HOLDER=${ resources__.production.holder { setup = setup : ''${ setup } --pid-index 8 --resource "$DOT_SSH" --resource "$GPG" --resource "$SSH"'' ; failure = failure "9292d02e" ; } }
                                                                                                                                                                export HOLDER

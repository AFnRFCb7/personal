                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                                        ...
                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                text =
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        git config alias.mutable-audit "!${ builtins.concatStringsSep "" [ "$" "{" "MOUNT" "}" ] }/stage/alias/root/mutable-audit"
                                                                                                                                                        # spellcheck disable=SC2086
                                                                                                                                                        git config alias.mutable-mirror "!${ builtins.concatStringsSep "" [ "$" "{" "MOUNT" "}" ] }/stage/alias/root/mutable-mirror"
                                                                                                                                                        # spellcheck disable=SC2086
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-nurse } stage/alias/root/mutable-nurse 0500 --literal-plain 1 --literal-plain 2 --literal-plain 3 --literal-plain INPUT --literal-plain REPO_NAME --literal-plain TOKEN --literal-plain USER_NAME

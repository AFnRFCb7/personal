                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        ( resources-fun false false false true false ( self + "/expected/false/false/false/true/false/0/checkpoint-pre" ) ( self + "/expected/false/false/false/true/false/0/checkpoint-post" ) [ { command = "/build/resources/0000000000000002/repair" ; checkpoint = self + "/expected/false/false/false/true/false/0/checkpoint-post" ; } ] )

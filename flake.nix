                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-mirror.root } stage/alias/root/mutable-mirror 0500 --literal-plain --literal-plain NEW_BRANCH --literal-plain OLD_BRANCH --literal-plain PATH --literal-plain UUID

                                                        ...
                                                        expected =
{
    ...
    primary = {
      buildFHSUserEnv = {
        __functionArgs = {
          dieWithParent = true;
          extraBwrapArgs = true;
          extraInstallCommands = true;
          extraPreBwrapCmds = true;
          meta = true;
        ...
        override = {
          __functionArgs = {
            ...
            pkgsi686Linux = false;
            runCommandCC = false;
            runCommandLocal = false;
            stdenv = false;
            writeShellScript = false;
          };
          __functor = null;
        };
      };
      channel = 58c7d369b0ce01c248dc06747e2414e64190b49ec8b54ab8b5d20f96a2033759636788d718be578255e47ea0ab95810bfe7e027b8bd7f7eb4c1d3bfb5e682480;
      coreutils = /nix/store/f8bb29v1w8mhkkxc15xan6mxvbkcbg3s-coreutils-9.5;
      failure = /nix/store/xir6v0gin64yd9q0spy7vlabfzcbiybq-failure;
      findutils = /nix/store/0lgw02xh80qnvbrhwjjvw0vp6384sgjs-findutils-4.10.0;
      flock = /nix/store/ka2xxzrj7p2ba7qj7j3qiwdlmbjc6j32-flock-0.4.0;
      jq = /nix/store/0q85yfxd70aq8iv4n43hqcmh2dbyb80z-jq-1.7.1-bin;
      makeBinPath = null;
      makeWrapper = /nix/store/nmlyrgn3klrc349b24k8yascjy62687p-make-shell-wrapper-hook;
      mkDerivation = null;
      nix = /nix/store/dlzcxfyhwpvbwi907qsamgsqvi09gvd2-nix-2.24.14;
      originator-pid-variable = c8f5d41a0628fd3c396fe940332263f7cd53f0caa6b656e12466dfdcb4173a6c0537736ab0bc1a37344a748febdd1eab5cc65c20493218afb606dc4c74b4e38d;
      ps = /nix/store/14lksafm0k57pg2j48c9fi09159smf1s-ps-procps-4.0.4;
      redis = /nix/store/9ap0znk8zci1j8cp06wysciy253yxk7c-redis-7.2.7;
      resources = {
      ...
      yq-go = /nix/store/hyccshqrkd4br8p0ybgwj5knnmr5ckyq-yq-go-4.44.3;
    };
    secondary = {
      init = null;
  ...
  hash = 8088cb06c3bb4e6adc87825eb0e49731c5908d4ac0df1794dbf7b1011afb672babeac98fcf1cfd6282401c23aa917c024232c88fc3a2eda0af926f9f861a88fa;
  index = 0000000311691948;
  init-script = /nix/store/q51nwp3rm31f5bwcr1azh7hqqmvzc9r2-init/bin/init;
  originator-pid = 45;
  provenance = new;
  standard-error = ;
  ...
  standard-output =  _________________________________________

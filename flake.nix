                                                                                                                        ...
                                                                                                                        let
                                                                                                                            ...
                                                                                                                            in
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    wrap ${ mutable-switch.root } stage/alias/root/mutable-switch 0500 --set-plain BRANCH --set-plain MOUNT "${ mount }" --literal-plain PATH --literal-plain UUID
                                                                                                                                    wrap ${ mutable-switch.submodule } stage/alias/submodule/mutable-switch 0500 --literal BRANCH --literal--plain name --literal-plain PATH --literal-plain TOKEN --literal-plain toplevel --literal-plain UUID
                                                                                                                                    wrap ${ mutable-test } stage/alias/root/mutable-test 0500 --set-plain MOUNT "${ mount }" --literal-plain PATH
                                                                                                                                    wrap ${ ssh } stage/ssh/command 0500 --literal-plain "@" --set-plain MOUNT "${ mount }" --literal-plain INDEX
                                                                                                                                    DOT_SSH=${ resources.production.dot-ssh ( setup : setup ) }
                                                                                                                                    root "$DOT_SSH"
                                                                                                                                    wrap "$DOT_SSH/config" stage/ssh/config 0400
                                                                                                                                    git remote add origin "${ config.personal.repository.private.remote }"

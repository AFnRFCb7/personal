                                                                                                                                ...
                                                                                                                                let
                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                gh pr create --base ${ config.personal.secrets.branch } --head "$BRANCH" --title "update github identity" --body ""
                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                SECRETS=${ resources.production.repository.secrets2.read-only { failure = "failure 64ef3c7e" ; } }
                                                                                                                                                                gh auth login --with-token < "$SECRETS/stage/github/token.asc"
                                                                                                                                                                gh pr create --base ${ config.personal.secrets.branch } --head "$BRANCH" --title "update github token" --body ""
                                                                                                                                                                URL="$( gh pr view --json url --jq .url )" || failure 864bc6e6
                                                                                                                                                                gh pr merge "$URL" --rebase
                                                                                                                                                                gh auth logout
                                                                                                                                                            '' ;
                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                SECRETS=${ resources.production.repository.secrets2.read-only { failure = "failure 64ef3c7e" ; } }
                                                                                                                                                                gh auth login --with-token < "$SECRETS/stage/github/token.asc"
                                                                                                                                                                gh pr create --base ${ config.personal.secrets.branch } --head "$BRANCH" --title "update github known-hosts" --body ""
                                                                                                                                                                URL="$( gh pr view --json url --jq .url )" || failure 864bc6e6
                                                                                                                                                                gh pr merge "$URL" --rebase
                                                                                                                                                                gh auth logout
                                                                                                                                                            '' ;
                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                git push origin "$BRANCH"
                                                                                                                                                                gh auth login --with-token < "$SECRETS/stage/github/token.asc"
                                                                                                                                                                gh pr create --base ${ config.personal.secrets.branch } --head "$BRANCH" --title "update dot-gnupg" --body ""
                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                gh pr create --base ${ config.personal.secrets.branch } --head "$BRANCH" --title "update mobile known-hosts" --body ""
                                                                                                                                                                URL="$( gh pr view --json url --jq .url )" || failure 864bc6e6
                                                                                                                                                                gh pr merge "$URL" --rebase
                                                                                                                                                                gh auth logout
                                                                                                                                                            '' ;
                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                git push origin "$BRANCH"
                                                                                                                                                                gh auth login --with-token < "$SECRETS/stage/github/token.asc"
                                                                                                                                                                gh pr create --base ${ config.personal.secrets.branch } --head "$BRANCH" --title "update mobile identity" --body ""
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ...
                                                                                                                                            git remote add origin git@github.com:${ config.personal.secrets.organization }/${ config.personal.secrets.repository }

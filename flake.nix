                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        ( resources-fun false false false true false ( self + "/expected/false/false/false/true/false/0/checkpoint-pre" ) ( self + "/expected/false/false/false/true/false/0/checkpoint-post" ) [ { command = "/build/resources/recovery/0000000000000002/cceeae81-ba80-4932-81f5-1782ed9b033e.sh" ; checkpoint = self + "/expected/false/false/false/true/false/1/checkpoint" ; } ] )

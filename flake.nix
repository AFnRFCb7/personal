                                                                                                                                                ...
                                                                                                                                                pkgs.writeShellApplication
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        text =
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                SECRETS=${ builtins.trace ( builtins.concatStringsSep " , " ( builtins.attrNames resources.production.repository ) ) ( resources.production.repository.secrets ( setup : setup ) ) }

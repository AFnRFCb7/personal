                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        # ( resources-fun false false false false false false ( self + "/expected/false/false/false/true/false/false/0/checkpoint-pre" ) ( self + "/expected/false/false/false/true/false/false/0/checkpoint-post" ) [ ] )

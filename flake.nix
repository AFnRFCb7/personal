                                                                                                    ...
                                                                                                    let
                                                                                                        ...
                                                                                                        in
                                                                                                            ''
                                                                                                                ...
                                                                                                                wrap ${ pre-push } cipher/.git/hooks/pre-push 0500 --literal-plain GITHUB_PUBLIC --literal-plain GIT_SSH_COMMAND --literal-brace "GIT_SSH_COMMAND:?GIT_SSH_COMMAND must be exported" --literal-plain MOBILE_PUBLIC --inherit-plain MOUNT --literal-plain PATH --uuid c49c4509
                                                                                                            '' ;
                                                                                            } ;
                                                                                    in "${ application }/bin/init" ;

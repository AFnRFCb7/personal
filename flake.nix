                                                                            ...
                                                                            origin : input-script : sed : ignore :
                                                                                {
                                                                                    ...
                                                                                    init-text =
                                                                                        ''
                                                                                            ...
                                                                                            git checkout "$COMMIT"
                                                                                            ${ if sed then "sed -i ${ builtins.concatStringsSep " " ( builtins.attrValues ( builtins.mapAttrs ( name : value : ''-e "s#\(${ name }.url.*\".*\)\"#\1?ref\"#"'' ) resources.milestone.source.inputs ) ) }" else "#" }
                                                                                        '' ;
                                                                                } ;
                                                                        in
                                                                            {

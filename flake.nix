                ...
                lib =
                    {
                        ...
                        let
                            _dot-gnupg = { ownertrust , secret-keys } : dot-gnupg.lib { coreutils = pkgs.coreutils ; ownertrust = ownertrust ; secret-keys = secret-keys ; writeShellApplication = writeShellApplication ; } ;

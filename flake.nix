                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        ( resources-fun false false false true false ( self + "/expected/false/false/false/true/false/0/checkpoint-pre" ) ( self + "/expected/false/false/false/false/false/0/checkpoint-post" ) [ ] )

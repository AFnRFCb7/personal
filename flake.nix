                                                                                                    ...
                                                                                                    pkgs.writeShellApplication
                                                                                                        {
                                                                                                            ...
                                                                                                            text =
                                                                                                                let
                                                                                                                    ...
                                                                                                                    in
                                                                                                                        ''
                                                                                                                            wrap ${ mutable-build-vm } stage/bin/mutable-build-vm 0500 --literal GIT_SSH_COMMAND --literal MUTABLE_SNAPSHOT --set MOUNT "${ mount }" --literal PATH --set VM "build-vm"
                                                                                                                            wrap ${ mutable-build-vm } stage/bin/mutable-build-vm-with-bootloader 0500 --literal MUTABLE_SNAPSHOT --set MOUNT "${ mount }" --literal PATH --set VM "build-vm-with-bootloader"
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-token } stage/bin/mutable-token 0500 --literal PATH --literal TOKEN --literal RECIPIENTS --set MOUNT "${ mount }"

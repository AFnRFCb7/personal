                                                                                                                                ...
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ...
                                                                                                                                            ${ ssh pkgs resources root wrap }
                                                                                                                                            wrap ${ github-identity } stage/alias/github-identity 0500 --literal-plain BRANCH --literal-plain key-id --inherit-plain MOUNT --literal-plain PATH --literal-plain RECIPIENT --literal-plain RECIPIENT_ --literal-plain SECRETS --literal-plain UUID --literal-plain URL

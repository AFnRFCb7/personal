                                                                                                            ...
                                                                                                            let
                                                                                                                ...
                                                                                                                in
                                                                                                                    ''
                                                                                                                        ...
                                                                                                                        if nixos-rebuild build --flake "$FILE#user" "${ builtins.concatStringsSep "" [ "$" "{" "INPUTS[*]" "}" ] }" > /mount/standard-output 2> /mount/standard-error
                                                                                                                        then
                                                                                                                            echo "$?" > /mount/status
                                                                                                                        else
                                                                                                                            echo "$?" > /mount/status
                                                                                                                ...
                                                                                                                pkgs.writeShellApplication
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        text =
                                                                                                                            ''
                                                                                                                                ...
                                                                                                                                if [[ ! -d inputs/secrets ]]
                                                                                                                                then
                                                                                                                                    git submodule add --branch main github:AFnRFCb7/12e5389b-8894-4de5-9cd2-7dab0678d22b inputs/secrets 2>&1
                                                                                                                                fi
                                                                                                                                if [[ ! -d inputs/string ]]
                                                                                                                                then

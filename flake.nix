                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        ( resources-fun false false false true false false ( self + "/expected/false/false/false/true/false/false/0/checkpoint-pre" ) ( self + "/expected/false/false/false/true/false/false/0/checkpoint-post" ) [ { command = "/build/resource/recovery/0000000000000006/recover.sh" ; checkpoint = self + "/expected/false/false/false/true/false/false/1/checkpoint" ; } ] )

                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-mirror.root } stage/alias/root/mutable-mirror 0500 --literal-plain NEW_BRANCH --literal-plain OLD_BRANCH --literal-plain PATH --literal-plain UUID
                                                                                                                            wrap ${ mutable-mirror.submodule } stage/alias/submodule/mutable-mirror 0500 --literal-plain BRANCH --literal-plain PATH --literal-plain UUID
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-rebase } stage/alias/root/mutable-rebase 0500 --set-plain MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-snapshot.root } stage/alias/root/mutable-snapshot 0500 --set-plain MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable-snapshot.submodule } stage/alias/submodule/mutable-snapshot 0500 --set-plain MOUNT "${ mount }"

                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-nurse } stage/alias/root/mutable-nurse 0500 --literal-plain 1 --literal-plain 2 --literal-plain 3 --literal-plain INPUT --set-plain MOUNT "${ mount }" --literal-plain REPO_NAME --literal-plain TOKEN --literal-plain USER_NAME
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-rebase.root } stage/alias/root/mutable-rebase 0500 --literal-plain BRANCH --literal-plain COMMIT --set-plain INDEX "$INDEX" --set-plain MOUNT "${ mount }" --literal-plain MUTABLE_SNAPSHOT --literal-plain name --literal-plain NAME --literal-plain PATH --literal-plain UUID --literal-plain TOKEN --literal-plain TOKEN_DIRECTORY
                                                                                                                            wrap ${ mutable-rebase.submodule } stage/alias/submodule/mutable-rebase 0500 --literal-plain BRANCH --literal-plain COMMIT --set-plain INDEX "$INDEX" --set-plain MOUNT "${ mount }" --literal-plain MUTABLE_SNAPSHOT --literal-plain name --literal-plain NAME --literal-plain PATH --literal-plain UUID --literal-plain TOKEN --literal-plain TOKEN_DIRECTORY
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-snapshot.submodule } stage/alias/submodule/mutable-snapshot 0500 --literal-plain BRANCH --literal-plain NAME --set-plain MOUNT "${ mount }" --literal-plain name --literal-plain PATH --literal-plain TOKEN --literal-plain TOKEN_DIRECTORY --literal-plain toplevel --literal-plain UUID

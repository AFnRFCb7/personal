                                                                                                                                ...
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ...
                                                                                                                                            ${ ssh pkgs resources root wrap }
                                                                                                                                            wrap ${ github-known-hosts } stage/alias/github-known-hosts 0500 --literal-plain BRANCH --inherit-plain MOUNT --literal-plain PATH --literal-plain RECIPIENT --literal-plain RECIPIENT_ --literal-plain SECRETS --literal-plain URL
                                                                                                                                            git fetch origin ${ config.personal.secrets2.branch } 2>&1
                                                                                                                                            git checkout origin/${ config.personal.secrets2.branch } 2>&1

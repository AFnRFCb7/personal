                                            ...
                                            list =
                                                builtins.concatLists
                                                    [
                                                        ...
                                                        ( resources-fun false false false true false true ( self + "/expected/false/false/false/true/false/true/0/checkpoint-pre" ) ( self + "/expected/false/false/false/true/false/true/0/checkpoint-post" ) [ ] )

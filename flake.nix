                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable- "build-vm" } stage/alias/root/mutable-build-vm 0500 --set-plain MOUNT "${ mount }"
                                                                                                                            wrap ${ mutable- "build-vm-with-bootloader" } stage/alias/root/mutable-build-vm-with-bootloader 0500 --set-plain MOUNT "${ mount }"
                                                                                                                        ...
                                                                                                                        let
                                                                                                                            ...
                                                                                                                            in
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    git config user.name "${ config.personal.repository.private.name }"
                                                                                                                                    git config core.sshCommand "${ mount }/stage/ssh/command"
                                                                                                                                    wrap ${ mutable-build-vm "build-vm" } stage/alias/root/mutable-build-vm 0500
                                                                                                                                    wrap ${ mutable-build-vm "build-vm-with-bootloader" } stage/alias/root/mutable-build-vm-with-bootloader 0500
                                                                                                                                    wrap ${ mutable-check } stage/alias/root/mutable-check 0500 --set-plain MOUNT "${ mount }"

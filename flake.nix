                                                                                                                                ...
                                                                                                                                let
                                                                                                                                    ...
                                                                                                                                    in
                                                                                                                                        ''
                                                                                                                                            ...
                                                                                                                                            ${ ssh pkgs resources root wrap }
                                                                                                                                            wrap ${ github-known-hosts } stage/alias/github-known-hosts 0400 --literal-plain BRANCH --inherit-plain MOUNT --literal-plain PATH --literal-plain RECIPIENT --literal-plain RECIPIENTS_ --literal-plain SECRETS --literal-plain URL

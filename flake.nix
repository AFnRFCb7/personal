                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable- "check" } stage/alias/root/mutable-check 0500 --set-plain MOUNT "${ mount }" --literal-plain MUTABLE_SNAPSHOT --literal-plain PATH
                                                                                                                            wrap ${ mutable-mirror.root } stage/alias/root/mutable-mirror 0500 --set-plain MOUNT "${ mount }"

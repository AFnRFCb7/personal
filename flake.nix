                                                                            ...
                                                                            origin : input-script : sed : ignore :
                                                                                {
                                                                                    ...
                                                                                    init-text =
                                                                                        ''
                                                                                            ...
                                                                                            sed -i ${ builtins.concatStringsSep " " ( builtins.attrValues ( builtins.mapAttrs ( name : value : ''-e "s#?ref=main#?ref=REVISION_TOKEN#" ) resources.milestone.source.inputs ) ) } "$GIT_WORK_TREE/flake.nix"
                                                                                        '' ;
                                                                                } ;
                                                                        in
                                                                            {

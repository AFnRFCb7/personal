                                                                                                                ...
                                                                                                                let
                                                                                                                                ...
                                                                                                                                pkgs.writeShellApplication
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        text =
                                                                                                                                            ''
                                                                                                                                                ...
                                                                                                                                                URL="$( gh pr view --json url --jq .url )" || failure db1ca161
                                                                                                                                                gh pr merge "$URL" --rebase
                                                                                                                                                gh auth logout
                                                                                                                                            '' ;
                                                                                                                                    } ;
                                                                                                                    ...
                                                                                                                    in
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-token } stage/bin/mutable-token 0500 --literal BRANCH --literal PATH --literal RECIPIENTS --literal RECIPIENTS_FILE --literal TOKEN --literal TOKEN_FILE --literal UUID --set-plain MOUNT "${ mount }"

                                                                                                            ...
                                                                                                            pkgs.writeShellApplication
                                                                                                                {
                                                                                                                    ...
                                                                                                                    text =
                                                                                                                        ...
                                                                                                                        ''
                                                                                                                            ...
                                                                                                                            wrap ${ mutable-snapshot.submodule } stage/alias/submodule/mutable-snapshot 0500 --literal-plain BRANCH --literal-plain NAME --literal-plain PATH --literal-plain TOKEN --literal-plain TOKEN_DIRECTORY --literal-plain UUID
                                                                                                                            wrap ${ mutable-squash } stage/alias/root/mutable-squash 0500 --literal-plain BRANCH --literal-plain name --set-plain MOUNT "${ mount }" --literal-plain PATH --literal-plain toplevel --literal-plain UUID

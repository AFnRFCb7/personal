                                                                                                                    ...
                                                                                                                    pkgs.writeShellApplication
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            text =
                                                                                                                                ...
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    wrap ${ mutable-reset.submodule } stage/alias/submodule/mutable-reset 0500 --literal-plain BRANCH --inherit-plain MOUNT --literal-plain name --literal-plain PATH --literal-plain toplevel --literal-plain UUID

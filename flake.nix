                                                                                                                        ...
                                                                                                                        let
                                                                                                                            ...
                                                                                                                            in
                                                                                                                                ''
                                                                                                                                    ...
                                                                                                                                    wrap ${ mutable-switch.submodule } stage/alias/submodule/mutable-switch 0500 --literal-plain BRANCH --literal--plain name --literal-plain PATH --literal-plain TOKEN --literal-plain toplevel --literal-plain UUID
